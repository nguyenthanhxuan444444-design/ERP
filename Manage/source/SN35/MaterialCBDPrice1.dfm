      ...
      object DBGrid1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'ProfitR'
            Footers = <>
            Title.Caption = 'ProfitR'#13#10'1-(PUR/Costing)'
            Width = 107
          end
          item
            EditButtons = <>
  ...
  object XXMQ: TQuery
    ...
    SQL.Strings = (
      '---------------------------'
        ...
        'ISNULL(CGBJS.USPrice,case  when CGBJS.USPrice IS NULL then CGBJS' +
        '.VNPrice/MaterialCBDEx.CWHL ELSE CGBJS.USPrice END) as USPrice,C' +
        'GBJS.VNPrice'
      ',CGBJS.Discount'
      
        ',ISNULL(CGBJS.USPrice,case  when CGBJS.USPrice IS NULL then CGBJ' +
        'S.VNPrice/MaterialCBDEx.CWHL ELSE CGBJS.USPrice END)*CGBJS.Disco' +
        'unt as USDxDis'
      ',case when MaterialCBD.SamplePrice is not null then '
      
        '1-(ISNULL(CGBJS.USPrice,case  when CGBJS.USPrice IS NULL then CG' +
        'BJS.VNPrice/MaterialCBDEx.CWHL ELSE CGBJS.USPrice END)*CGBJS.Dis' +
        'count/MaterialCBD.SamplePrice) end as ProfitR'
      ',CGBJS.USERID as PurUser,CGBJS.USERDate as PurUSERDate'
      'FROM '
      '('
      ...
      ' ) XXZLS'
        ...
        ' left join DDZL on DDZL.XieXing=XXZLS.XieXing and DDZL.SheHao=XX' +
        'ZLS.SheHao'
      
        'Left join XXZL on XXZL.XieXIng=XXZLS.XieXing and XXZL.Shehao=XXZ' +
        'LS.SheHao '
      ' and XXZL.KFCQ='#39'YIH'#39' '
      'and XXZL.KHDH='#39'0062'#39' '
      ...
      'LEFT JOIN ZSZL on ZSZL.ZSDH=XXZLS.CSBH'
        ...
        'CLBH'
      '   and MaterialCBD.Season ='#39'S26'#39
      '   and MaterialCBD.KHDH='#39'0062'#39' '
      ' and MaterialCBD.YN=0'
        ...
        'left join CGBJS on CGBJS.Season=MaterialCBD.Season and CGBJS.CLB' +
        'H=MaterialCBD.CLBH'
      
        'left join MaterialCBDEx on MaterialCBDEx.Season=MaterialCBD.Seas' +
        'on '
      'where XXZL.Article like '#39'1168950-KKB%'#39'   AND CLZL.CLZMLB='#39'N'#39
      'and XXZLS.CLBH like '#39'C010009227%'#39
      ...
      'group by XXZLS.CLBH,CLZL.YWPM, CLZL.ZWPM,CLZL.DWBH,CLZL.CLZMLB,'
        ...
        'userID,MaterialCBD.userdate,MaterialCBD.Freight,CGBJS.USPrice,CG' +
        'BJS.VNPrice, MaterialCBDEx.CWHL,CGBJS.Discount,CGBJS.USERID,CGBJ' +
        'S.USERDate'
      'ORDER BY XXZLS.CLBH'
      '')
    Left = 212
    ...
    object XXMQUSPrice: TFloatField
      FieldName = 'USPrice'
      DisplayFormat = '0.0000'
    end
    object XXMQVNPrice: TCurrencyField
      FieldName = 'VNPrice'
      currency = False
    end
    object XXMQDiscount: TFloatField
      FieldName = 'Discount'
    end
    object XXMQUSDxDis: TFloatField
      FieldName = 'USDxDis'
    end
    object XXMQProfitR: TFloatField
      FieldName = 'ProfitR'
    end
    object XXMQPurUser: TStringField
      FieldName = 'PurUser'
      FixedChar = True
      Size = 15
    end
    object XXMQPurUSERDate: TDateTimeField
      FieldName = 'PurUSERDate'
    end
  end
