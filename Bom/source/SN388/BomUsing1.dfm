object BomUsing: TBomUsing
      ...
      object DBGrid1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'DIFF'
            Footers = <>
            Title.Caption = 'DIFF|'#29992#37327#24046#24322
          end
          item
            DisplayFormat = '0%'
            EditButtons = <>
  ...
  object XXZLS: TQuery
    ...
    SQL.Strings = (
        ...
        'select distinct XXZLS.XH, XXZLS.BWBH,BWZL.ywsm BWMC,XXZLS.CLBH,'#39 +
        'Assembly'#39' as DType,'
      ...
      '       XXZLS.CCQQ,XXZLS.CCQZ,CLZL.CLZMLB,XXZLS.userdate'
        ...
        '        ,MaterialCBD_BomUsing.Qty, xxzl.ARTICLE,MaterialCBD_BomU' +
        'sing.Qty-XXZLS.CLSL as DIFF,xxzl.bzcc,MaterialCBD_BomUsing.Formu' +
        'la, ((MaterialCBD_BomUsing.Qty-XXZLS.CLSL)/XXZLS.CLSL) as Varian' +
        'ce'
      'FROM XXZLS'
      ...
      'LEFT JOIN MaterialCBD_BomUsing'
      '  ON MaterialCBD_BomUsing.BWBH = XXZLS.BWBH'
      ' AND MaterialCBD_BomUsing.ARTICLE ='
      '     CASE'
      '       WHEN CHARINDEX('#39'-'#39', XXZL.ARTICLE) > 0'
      
        '         THEN LEFT(XXZL.ARTICLE, CHARINDEX('#39'-'#39', XXZL.ARTICLE) - ' +
        '1)'
      '       ELSE XXZL.ARTICLE'
      '     END'
      #9' where XXZL.ARTICLE like'#39'1110519%'#39' and xxzl.SheHao='#39'90'#39
      'ORDER BY XXZLS.BWBH'
      '')
    ...
    object XXZLSQty: TFloatField
      FieldName = 'Qty'
    end
    object XXZLSFormula: TStringField
      FieldName = 'Formula'
      FixedChar = True
      Size = 50
    end
    object XXZLSDIFF: TFloatField
      FieldName = 'DIFF'
    end
    ...
    object XXZLSbzcc: TStringField
      FieldName = 'bzcc'
      FixedChar = True
      Size = 6
    end
    object XXZLSVariance: TFloatField
      FieldName = 'Variance'
    end
  end
  object UpXXZLS: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  CASE'
        ...
        '    WHEN CHARINDEX('#39'-'#39', :Article) > 0 THEN LEFT(:Article, CHARIN' +
        'DEX('#39'-'#39', :Article) - 1)'
      '    ELSE :Article'
      '  END'
      '')
