object HumidityCheck: THumidityCheck
  Left = 262
  Top = 207
  Width = 1305
  Height = 691
  Caption = 'HumidityCheck'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    object Query1ArrQty: TIntegerField
      FieldName = 'ArrQty'
    end
    object Query1IQty: TIntegerField
      FieldName = 'IQty'
    end
    object Query1StandardRH: TStringField
      FieldName = 'StandardRH'
      FixedChar = True
    end
    object Query1RealityRH: TStringField
      FieldName = 'RealityRH'
      FixedChar = True
    end
  ...
  object UpSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into QC_HumidityCheck'
      
        '  (ReportID, InspecDate, Cont, MatName, Supplier, ArrQty, IQty, ' +
        'StandardRH, '
      
        '   RealityRH, InspecID, Remark, SCFID, SCFDate, LCFID, LCFDate, ' +
        'MSCFID, '
      '   MSCFDate, USERID, USERDate, PreparedID, PreparedDate, YN)'
      'values'
      
        '  (:ReportID, :InspecDate, :Cont, :MatName, :Supplier, :ArrQty, ' +
        ':IQty, '
      
        '   :StandardRH, :RealityRH, :InspecID, :Remark, :SCFID, :SCFDate' +
        ', :LCFID, '
      
        '   :LCFDate, :MSCFID, :MSCFDate, :USERID, :USERDate, :PreparedID' +
        ', :PreparedDate, '
      '   :YN)')
    DeleteSQL.Strings = (
