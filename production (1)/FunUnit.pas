...
uses
 ...
 type
   ...
   procedure GetBDE_DATABASENAME(AliasName:String;var DB_ERP:String;var DB_DD:String);
   private
...
//20180122  Get BDE Server IP
procedure TFuncOBj.GetBDE_DATABASENAME(AliasName:String;var DB_ERP:String;var DB_DD:String);
var BDElist:TStringList;
begin
  BDEList := TStringList.Create ;
  try
    Session.GetAliasParams(AliasName,BDEList);
    DB_ERP  := BDEList.Values['DATABASE NAME'];
    DB_DD   := Copy(DB_ERP,1,Pos('_',DB_ERP))+'DD';
  finally
    BDEList.Free;
  end;
end;
