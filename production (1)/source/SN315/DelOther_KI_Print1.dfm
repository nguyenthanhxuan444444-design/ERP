object DelOther_KI_Print: TDelOther_KI_Print
  Left = 233
  Top = 125
  Width = 928
  Height = 480
  Caption = 'DelOther_KI_Print'
  Color = clBtnFace
  ...
  object DelTot: TQuery
    CachedUpdates = True
    DatabaseName = 'DB'
    DataSource = DelOther_KI.DS3
    RequestLive = True
    SQL.Strings = (
      'select KCLLS.CLBH,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH,DDZL.Article'
      ...
      'group by KCLLS.CLBH,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH,DDZL.Article'
      '')
