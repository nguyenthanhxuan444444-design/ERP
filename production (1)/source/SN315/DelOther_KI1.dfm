object DelOther_KI: TDelOther_KI
  Left = 369
  Top = 173
  Width = 928
  Height = 480
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
        ...
        'select KCLLS.*,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH,DDZL.Quantity,CLZL_' +
        'KI.YWPM as YWPM_KI'
      'from KCLLS'
      'left join CLZL on CLZL.CLDH=KCLLS.CLBH'
      'left join KHUONIN_DDZL DDZL on KCLLS.SCBH=DDZL.DDBH'
      'left join CLZL CLZL_KI on CLZL_KI.CLDH = DDZL.Article'
    ...
    object DelDetR3Qty: TCurrencyField
      FieldName = 'R3Qty'
    end
    ...
    object DelDetQuantity: TIntegerField
      FieldName = 'Quantity'
    end
    object DelDetYWPM_KI: TStringField
      FieldName = 'YWPM_KI'
      FixedChar = True
      Size = 200
    end
