object DelOther_D: TDelOther_D
  ...
  object DelDet: TQuery
    ...
    object DelDetVNACC: TFloatField
      FieldName = 'VNACC'
    end
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into KCLL'
        ...
        'ID, YN, SEASON, PURPOSE, DEVTYPE)'
      'values'
      
        '  (:LLNO, :GSBH, :CKBH, :SCBH, :DepID, :USERDATE, :USERID, :CFMD' +
        'ate,:CFMID,:YN, :SEASON, :PURPOSE, :DEVTYPE)')
    DeleteSQL.Strings = (
      'delete from KCLL'
      'where'
      '  LLNO = :OLD_LLNO')
  ...
  object DCPopupMenu: TPopupMenu
    Left = 180
    Top = 342
    object Other1: TMenuItem
      Caption = 'Quantity Classify'
      OnClick = Other1Click
    end
  end
