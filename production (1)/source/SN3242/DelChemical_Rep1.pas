...
uses
  ...
  DBGridEh, Mask, Buttons, ExtCtrls ,IniFiles;

type
  TDelChemical_Rep = class(TForm)
    Panel1: TPanel;
    Label18: TLabel;
    BB2: TBitBtn;
    BB3: TBitBtn;
...
var
  DelChemical_Rep: TDelChemical_Rep;
  sdate,edate,NDate:TDate;

implementation

uses main1, DelChemical_Dep1, DelChemical_RepCL1, DelChemical_Mat1,
  DelChemical_RepPrint1, DelChemical_SCBH1,fununit;

{$R *.dfm}

procedure TDelChemical_Rep.FormDestroy(Sender: TObject);
begin
  DelChemical_Rep:=nil;
end;

procedure TDelChemical_Rep.FormClose(Sender: TObject;
...
procedure TDelChemical_Rep.ReadIni();
var MyIni :Tinifile;
    AppDir:string;
begin
  //
...
procedure TDelChemical_Rep.FormCreate(Sender: TObject);
var i:integer;
begin
  with Qtemp do
  begin
...
procedure TDelChemical_Rep.Button1Click(Sender: TObject);
begin
  with DelMas do
  begin
    active:=false;
    ...
    sql.add('     and KCLL.SCBH='+''''+'RRRRRBBBBB'+'''');
...
procedure TDelChemical_Rep.BB7Click(Sender: TObject);
begin
  close;
end;

procedure TDelChemical_Rep.BD7Click(Sender: TObject);
begin
  close;
end;

procedure TDelChemical_Rep.BB2Click(Sender: TObject);
begin  
  with DelMas do
  begin
    requestlive:=true;
...
procedure TDelChemical_Rep.BB3Click(Sender: TObject);
begin  
...
procedure TDelChemical_Rep.BB4Click(Sender: TObject);
begin
...
procedure TDelChemical_Rep.BB5Click(Sender: TObject);
var y,m,a:string;
    i:integer;
begin
                ...
                begin
                  DelMas.delete;
                   ...
                   begin
                     ...
                     DelMas.fieldbyname('SCBH').Value:='RRRRRBBBBB' ;
...
procedure TDelChemical_Rep.BD2Click(Sender: TObject);
begin 
...
procedure TDelChemical_Rep.BD3Click(Sender: TObject);
begin
...
procedure TDelChemical_Rep.BD4Click(Sender: TObject);
begin
...
procedure TDelChemical_Rep.BD5Click(Sender: TObject);
var i:integer;
begin
  with DelDet do
  begin
...
procedure TDelChemical_Rep.BD6Click(Sender: TObject);
begin
...
procedure TDelChemical_Rep.BB6Click(Sender: TObject);
begin
...
procedure TDelChemical_Rep.BBT1Click(Sender: TObject);
begin
  DelMas.First;
end;

procedure TDelChemical_Rep.BBT2Click(Sender: TObject);
begin
  DelMas.Prior;
end;

procedure TDelChemical_Rep.BBT3Click(Sender: TObject);
begin
  DelMas.next;
end;

procedure TDelChemical_Rep.BBT4Click(Sender: TObject);
begin
  DelMas.last;
end;

procedure TDelChemical_Rep.BDT1Click(Sender: TObject);
begin
  DelDet.first;
end;

procedure TDelChemical_Rep.BDT2Click(Sender: TObject);
begin
  DelDet.prior;
end;

procedure TDelChemical_Rep.BDT3Click(Sender: TObject);
begin
  DelDet.next;
end;

procedure TDelChemical_Rep.BDT4Click(Sender: TObject);
begin
  DelDet.last;
end;

procedure TDelChemical_Rep.BBTT1Click(Sender: TObject);
begin
  DelChemical_Dep:=TDelChemical_Dep.Create(self);
  DelChemical_Dep.ParentQry:=DelChemical_Rep.DelMas;
  DelChemical_Dep.Show;
end;

procedure TDelChemical_Rep.DelDetAfterOpen(DataSet: TDataSet);
begin
...
procedure TDelChemical_Rep.BBTT2Click(Sender: TObject);
begin

  if messagedlg('Select material from order?',mtinformation,[mbYes,mbNo],0)=mrYes then
  begin
    DelChemical_RepCL:=TDelChemical_RepCL.create(self);
    DelChemical_RepCL.ParentQry:=DelChemical_Rep.DelDet;
    DelChemical_RepCL.show;
  end
  else
    begin
      DelChemical_Mat:=TDelChemical_Mat.create(self);
      DelChemical_Mat.ParentQry:=DelChemical_Rep.DelDet;
      DelChemical_Mat.CKBH:=DelChemical_Rep.DelMas.fieldbyname('CKBH').AsString;
      DelChemical_Mat.show;
    end;
  //
end;

procedure TDelChemical_Rep.PC1Change(Sender: TObject);
begin
...
procedure TDelChemical_Rep.DBGrid3DblClick(Sender: TObject);
begin
...
procedure TDelChemical_Rep.DBGrid3EditButtonClick(Sender: TObject);
begin
  BBTT1Click(nil);
end;

procedure TDelChemical_Rep.DBGrid4EditButtonClick(Sender: TObject);
begin
  ...
  begin
    ...
    DelChemical_SCBH.ParentQry:=DelChemical_Rep.DelDet;
    DelChemical_SCBH.show;
  end

end;

procedure TDelChemical_Rep.BDT5Click(Sender: TObject);
begin
  ...
  begin
    ...
    abort;
      ...
      begin
        DelChemical_RepPrint:=TDelChemical_RepPrint.Create(nil);
        DelChemical_RepPrint.quickrep1.prepare;
        DelChemical_RepPrint.Qpage1.caption:=inttostr(DelChemical_RepPrint.quickrep1.QRPrinter.pagecount);
        DelChemical_RepPrint.quickrep1.preview;
        DelDet.active:=false;
        DelDet.active:=true;
        DelChemical_RepPrint.Free;
      end;
  with DelMas do
  begin
    requestlive:=true;
...
procedure TDelChemical_Rep.DelMasAfterOpen(DataSet: TDataSet);
begin
...
procedure TDelChemical_Rep.DelDetCalcFields(DataSet: TDataSet);
begin
...
procedure TDelChemical_Rep.DBGrid3KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TDelChemical_Rep.Other1Click(Sender: TObject);
begin
...
procedure TDelChemical_Rep.DBGrid3GetCellParams(Sender: TObject;
...
procedure TDelChemical_Rep.DBGrid4GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin   
...
procedure TDelChemical_Rep.BB1Click(Sender: TObject);
begin
  panel2.Visible:=true;
end;
