object StockShoeMonth: TStockShoeMonth
  ...
  object Query2: TQuery
    ...
    SQL.Strings = (
        ...
        'Select ROW_NUMBER() OVER (ORDER BY YWDDM.DDBH) AS STT,YWDDM.DDBH' +
        ',YWDDM.YSBH,YWDDM.CKBH,IsNull(YWDD.Qty,DDZL.Pairs) as Pairs,YWDD' +
        'M.LastRem,YWDDM.RKQty,YWDDM.XHQty,YWDDM.TRQty,YWDDM.Qty,'
