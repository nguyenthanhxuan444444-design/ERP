object ReplenishDel_Print: TReplenishDel_Print
  ...
  object BLDet: TQuery
    ...
    SQL.Strings = (
        ...
        '+'#39' '#39'+CLZL.DWBH as MatName,REPLACE(SCBLS.SIZE,'#39'ZZZZZZ'#39','#39#39') as SIZ' +
        'E'
      
        '       ,IsNull(OrdCL.CLSL,OrdCLAll.CLSL) as CLSL,SCBLS.Qty ,BLOl' +
        'd.QtyOld '
      'from ( '
      ...
      #9'where SCBLS.Qty>0 and SCBLS.BLNO=:BLNO '
      '       and  SCBLS.MJBH='#39'ZZZZZZZZZZ'#39' '
      '   ) SCBLS Group by BWBH,CLBH,SIZE'
      ') SCBLS'
      ...
      '              and ZLZLS2.MJBH='#39'ZZZZZZZZZZ'#39' '
        ...
        'left join (select ZLZLS2.BWBH,ZLZLS2.CLBH,sum(ZLZLS2.CLSL) as CL' +
        'SL'
      '        from ZLZLS2'
      '        where ZLZLS2.ZLBH=:ZLBH '
      '              and ZLZLS2.MJBH='#39'ZZZZZZZZZZ'#39' '
      
        '        group by ZLZLS2.BWBH,ZLZLS2.CLBH) OrdCLAll  on SCBLS.BWB' +
        'H=OrdCLAll.BWBH  and SCBLS.CLBH=OrdCLAll.CLBH '
      ...
      #9'left join SCBL on SCBL.BLNO=SCBLS.BLNO'
        ...
        #9'left join SCBLSS on SCBLSS.BLNO=SCBLS.BLNO and SCBLSS.BWBH=SCBL' +
        'S.BWBH and SCBLSS.CLBH=SCBLS.CLBH '
      #9'where SCBLS.Qty>0 and SCBL.ZLBH=:ZLBH  '
      '       and  SCBLS.MJBH='#39'ZZZZZZZZZZ'#39' '
      '  ) SCBLS Group by BWBH,CLBH,SIZE'#9#9' '
  ...
  object QApprover: TQuery
    ...
    object QApproverSupvervisorID: TStringField
      FieldName = 'SupvervisorID'
      FixedChar = True
      Size = 40
    end
    object QApproverSupvervisor: TStringField
    ...
    object QApproverXVID: TStringField
      FieldName = 'XVID'
      FixedChar = True
      Size = 40
    end
    object QApproverXV: TStringField
      FieldName = 'XV'
      FixedChar = True
      Size = 60
    end
    object QApproverXVDate: TStringField
      FieldName = 'XVDate'
      FixedChar = True
      Size = 30
    end
    object QApproverKHID: TStringField
      FieldName = 'KHID'
      FixedChar = True
      Size = 40
    end
    object QApproverKH: TStringField
      FieldName = 'KH'
      FixedChar = True
      Size = 60
    end
    object QApproverKHDate: TStringField
      FieldName = 'KHDate'
      FixedChar = True
      Size = 30
    end
    object QApproverKHManagerID: TStringField
      FieldName = 'KHManagerID'
      FixedChar = True
      Size = 40
    end
    object QApproverKHManager: TStringField
      FieldName = 'KHManager'
      FixedChar = True
      Size = 60
    end
    object QApproverKHManagerDate: TStringField
      FieldName = 'KHManagerDate'
      FixedChar = True
      Size = 30
    end
  end
