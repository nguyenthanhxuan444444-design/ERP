object DelChemical_CL: TDelChemical_CL
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'WBH ,IsNull(ERP_CLZL.TYJH,'#39#39') as TYJH,DDZL.YN,DDZL.DDBH'
      ...
      '           where KCLL.USERDate>getdate()-90 and KCLLS.BLSB='#39'Y'#39' '
      ...
      'and DDZL.DDBH  like '#39'%-B%'#39' '
      'and DDZL.ZLBH1 like '#39'%'#39
      'and DDZL.DDBH like '#39'Y1704-0088-B1%'#39' '
      'and IsNull(ERP_CLZL.TYJH,'#39#39')<>'#39'Y'#39' '
      
        'GROUP BY  ZLZLS3.cldhz ,DDZL.ZLBH1,CLZL.zwpm,CLZL.ywpm,DDZL.CQDH' +
        ',KCLLS.Qty ,CLZL.DWBH,ERP_CLZL.TYJH,DDZL.YN,DDZL.DDBH'
      '')
