object DelChemical_Print: TDelChemical_Print
  Left = 248
  Top = 129
  Width = 1025
  Height = 500
  Caption = 'DelChemical_Print'
  Color = clBtnFace
  ...
  object DelTot: TQuery
    CachedUpdates = True
    DatabaseName = 'DB'
    DataSource = DelChemical.DS3
    RequestLive = True
    SQL.Strings = (
      'select  KCLLS.CLBH,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH'
      '         ,sum(tempQty) as Qty,convert(varchar(250),'#39#39') as MEMO'
      'from KCLLS'
