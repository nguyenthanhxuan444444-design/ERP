unit PSpecPrintssTW1;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, QRPDFFilt, DBTables, DB, QuickRpt, QRCtrls, ExtCtrls, QRExport,IniFiles;

type
  TPSpecPrintssTW = class(TForm)
    QuickRep2: TQuickRep;
    DetailBand1: TQRBand;
    QRShape1: TQRShape;
    Q1: TQRDBText;
...
var
  PSpecPrintssTW: TPSpecPrintssTW;
...
{$R *.dfm}
procedure TPSpecPrintssTW.ReadIni();
var MyIni :Tinifile;
...
procedure TPSpecPrintssTW.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TPSpecPrintssTW.FormClose(Sender: TObject;
...
procedure TPSpecPrintssTW.TitlememoAfterOpen(DataSet: TDataSet);
...
procedure TPSpecPrintssTW.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
 Quickrep4.NewPage;
end;

procedure TPSpecPrintssTW.MemoTempAfterOpen(DataSet: TDataSet);
var a,b,c:string;
i,j:integer;
begin                   //加MEO說明文檔
...
with MemoOth do
  begin
    ...
    sql.add('and SheHao=:SheHao and ZYLB='+''''+'C'+'''');
 ...
 with MemoOth do
  begin
    ...
    sql.add('where exists(select  zlzls2.CLBH from zlzls2');
      ...
      begin
        with MemoSQL do
          begin
            ...
            FieldByName('RecN').asstring:=b;
            FieldByName('YWPM').AsString:='材料備注:';
        end;
        c:='';
        for j:=1 to recordcount do
          begin
...
procedure TPSpecPrintssTW.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
// Quickrep3.NewPage;
end;

procedure TPSpecPrintssTW.FormDestroy(Sender: TObject);
begin
PSpecPrintssTW:=nil;
end;

procedure TPSpecPrintssTW.QRCompositeReport1Finished(Sender: TObject);
begin

   PSpecPrintssTW.QRLabel22.Caption:=SpecISO;
   PSpecPrintssTW.QRLabel4.Caption:=SpecISO;
   PageHeaderBand1.Frame.DrawBottom:= true;
   PSpecPrintssTW.QRLabel60.Caption:=ComName;
   PSpecPrintssTW.QRLabel18.Caption:=ComName;
   PSpecPrintssTW.QRLabel23.Caption:=ComName;
   PSpecPrintssTW.QRLabel46.Caption:=ComFullName;
   PSpecPrintssTW.QRLabel54.Caption:=ComFullName;
   PSpecPrintssTW.QRLabel61.Caption:=ComFullName;

end;

procedure TPSpecPrintssTW.FormCreate(Sender: TObject);
begin
  ReadIni();
end;
