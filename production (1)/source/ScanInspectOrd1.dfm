object ScanInspectOrd: TScanInspectOrd
  Left = 310
  Top = 186
  Width = 870
  Height = 500
  Caption = 'ScanInspectOrd'
  Color = clBtnFace
  ...
  object YWDD: TQuery
    ...
    SQL.Strings = (
        ...
        'ng,DDZL.KHPO,LBZLS.YWSM as Country,YWDD.KHDDBH1,'
      
        '       YWDD.Qty,DDZL.Article,YWDD.ETD,YWDD.InspectDate,XXZL.CCGB' +
        ' as XXCC,DDZL.CCGB as DDCC,KFZL.KFJC,YWDD.InspectQty,'
      '       YWDD.InUserID,YWDD.InUserDate'
      'from YWDD'
      ...
      '      and KFZL.KFJC like '#39'%%'#39
        ...
        'etween '
      '      '#39'2009/05/01'#39'and '#39'2009/06/01'#39
    ...
    object YWDDInUserID: TStringField
      FieldName = 'InUserID'
      FixedChar = True
    end
    object YWDDInUserDate: TDateTimeField
      FieldName = 'InUserDate'
    end
  end
  ...
  object UpZL: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  InUserID=:InUserID,'
      '  InUserDate=:InUserDate'
      'where'
      '  DDBH = :OLD_DDBH')
    InsertSQL.Strings = (
      'insert into YWDD'
      '  (InspectDate, InspectQty,InUserID,InUserDate)'
      'values'
      '  (:InspectDate, :InspectQty,:InUserID,:InUserDate)')
    DeleteSQL.Strings = (
      'delete from YWDD'
