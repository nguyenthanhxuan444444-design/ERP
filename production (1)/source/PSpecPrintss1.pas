...
{$R *.dfm}
procedure TPSpecPrintss.ReadIni();
var MyIni :Tinifile;
...
procedure TPSpecPrintss.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TPSpecPrintss.FormClose(Sender: TObject;
...
procedure TPSpecPrintss.TitlememoAfterOpen(DataSet: TDataSet);
...
procedure TPSpecPrintss.ColumnHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 Quickrep4.NewPage;
end;

procedure TPSpecPrintss.MemoTempAfterOpen(DataSet: TDataSet);
var a,b,c:string;
i,j:integer;
begin                   //加MEO說明文檔
...
procedure TPSpecPrintss.FormDestroy(Sender: TObject);
begin
PSpecPrintss:=nil;
end;

procedure TPSpecPrintss.QRCompositeReport1Finished(Sender: TObject);
begin
   
   PSpecPrintss.QRLabel4.Caption:=SpecISO;
   PSpecPrintss.QRLabel22.Caption:=SpecISO;
   PageHeaderBand1.Frame.DrawBottom:= true;
   PSpecPrintss.QRLabel60.Caption:=ComName;
   PSpecPrintss.QRLabel18.Caption:=ComName;
   PSpecPrintss.QRLabel23.Caption:=ComName;
   PSpecPrintss.QRLabel61.Caption:=ComFullName;
   PSpecPrintss.QRLabel54.Caption:=ComFullName;
   PSpecPrintss.QRLabel46.Caption:=ComFullName;

end;

procedure TPSpecPrintss.FormCreate(Sender: TObject);
begin
  ReadIni();
end;
