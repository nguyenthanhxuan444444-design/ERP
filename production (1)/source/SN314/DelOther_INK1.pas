...
uses
  ...
  Buttons, ExtCtrls,math, GridsEh, DBGridEh ,IniFiles;

type
  TDelOther_INK = class(TForm)
    Panel1: TPanel;
    Label18: TLabel;
    BB2: TBitBtn;
    BB3: TBitBtn;
...
var
  DelOther_INK: TDelOther_INK;
  NDate:TDate;

implementation

uses main1,DelOther_INK_CL1, DelOther_INK_SCBH1, DelOther_INK_Print1,
     DelOther_INK_Dep1, DelOther_INK_Mat1;

{$R *.dfm}

procedure TDelOther_INK.BB1Click(Sender: TObject);
begin
  panel2.Visible:=true;
end;

procedure TDelOther_INK.Button1Click(Sender: TObject);
begin
  with DelMas do
  begin
    active:=false;
    ...
    sql.add('and KCLL.SCBH='+''''+'IIIIIIIIII'+'''');
...
procedure TDelOther_INK.ReadIni();
var MyIni :Tinifile;
    AppDir:string;
begin
  //
...
procedure TDelOther_INK.FormCreate(Sender: TObject);
var i:integer;
begin
  with Qtemp do
  begin
    ...
    for i:=1 to recordcount do
    begin
      DBGrid4.Columns[5].picklist.Add(fieldbyname('DFL').asstring);
      next;
    end;
    active:=false;
  end;
...
procedure TDelOther_INK.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if BB5.enabled  then
  begin
...
procedure TDelOther_INK.BB7Click(Sender: TObject);
begin
  close;
end;

procedure TDelOther_INK.BD7Click(Sender: TObject);
begin
  close;
end;

procedure TDelOther_INK.BB2Click(Sender: TObject);
begin
  with DelMas do
  begin
    requestlive:=true;
...
procedure TDelOther_INK.BB3Click(Sender: TObject);
begin
...
procedure TDelOther_INK.BB4Click(Sender: TObject);
begin
  with DelMas do
  begin
    requestlive:=true;
...
procedure TDelOther_INK.BB5Click(Sender: TObject);
var y,m,a:string;
    i:integer;
begin
        ...
        begin
          ...
          begin
           ...
           begin
             ...
             DelMas.fieldbyname('SCBH').Value:='IIIIIIIIII' ;
...
procedure TDelOther_INK.BD2Click(Sender: TObject);
begin
...
procedure TDelOther_INK.BD3Click(Sender: TObject);
begin
  if DelMas.RequestLive then
  begin
    showmessage('Pls save Master data first.');
...
procedure TDelOther_INK.BD4Click(Sender: TObject);
begin
  if DelMas.RequestLive then
  begin
    showmessage('Pls save Master data first.');
...
procedure TDelOther_INK.BD5Click(Sender: TObject);
var i:integer;
    N:single;
begin
  N:=0;
                  ...
                  if DelDet.fieldbyname('CLBH').isnull then
                    begin
                      ...
                      begin
                        ...
                        ///DelDet.FieldByName('SCBH').Value:='ZZZZZZZZZZ';
...
procedure TDelOther_INK.BD6Click(Sender: TObject);
begin
  with DelDet do
  begin
    active:=false;
...
procedure TDelOther_INK.BB6Click(Sender: TObject);
begin
  with DelMas do
  begin
    active:=false;
...
procedure TDelOther_INK.BBT1Click(Sender: TObject);
begin
  DelMas.First;
end;

procedure TDelOther_INK.BBT2Click(Sender: TObject);
begin
  DelMas.prior;
end;

procedure TDelOther_INK.BBT3Click(Sender: TObject);
begin
  DelMas.next;
end;

procedure TDelOther_INK.BBT4Click(Sender: TObject);
begin
  DelMas.last;
end;

procedure TDelOther_INK.BDT1Click(Sender: TObject);
begin
  DelDet.First;
end;

procedure TDelOther_INK.BDT2Click(Sender: TObject);
begin
  DelDet.prior;
end;

procedure TDelOther_INK.BDT3Click(Sender: TObject);
begin
  DelDet.next;
end;

procedure TDelOther_INK.BDT4Click(Sender: TObject);
begin
  DelDet.last;
end;

procedure TDelOther_INK.DelDetAfterOpen(DataSet: TDataSet);
begin
  BD2.Enabled:=true;
  BD3.Enabled:=true;
  BD4.Enabled:=true;
...
procedure TDelOther_INK.PC1Change(Sender: TObject);
begin
...
procedure TDelOther_INK.DBGrid3DblClick(Sender: TObject);
begin
...
procedure TDelOther_INK.DBGrid3EditButtonClick(Sender: TObject);
begin
  BBTT1Click(nil);
end;

procedure TDelOther_INK.DBGrid4EditButtonClick(Sender: TObject);
begin
  ...
  begin
    DelOther_INK_SCBH:=TDelOther_INK_SCBH.create(self);
    DelOther_INK_SCBH.show;
  end;
end;

procedure TDelOther_INK.BDT5Click(Sender: TObject);
begin
  ...
  begin
   ...
   begin
    DelOther_INK_Print:=TDelOther_INK_Print.Create(nil);
    DelOther_INK_Print.quickrep1.prepare;
    DelOther_INK_Print.Qpage1.caption:=inttostr(DelOther_INK_Print.quickrep1.QRPrinter.pagecount);
    DelOther_INK_Print.quickrep1.preview;
    DelDet.active:=false;
    DelDet.active:=true;
    DelOther_INK_Print.Free;
   end;
  with DelMas do
  begin
    requestlive:=true;
...
procedure TDelOther_INK.DelDetCalcFields(DataSet: TDataSet);
begin
...
procedure TDelOther_INK.DBGrid3KeyPress(Sender: TObject; var Key: Char);
begin
 if key=#13 then
    DBGrid3DblClick(nil);
end;

procedure TDelOther_INK.BBTT1Click(Sender: TObject);
begin
  DelOther_INK_Dep:=TDelOther_INK_Dep.Create(self);
  DelOther_INK_Dep.Show;
end;

procedure TDelOther_INK.DelMasAfterOpen(DataSet: TDataSet);
begin
  BB5.Enabled:=false;
  BB6.Enabled:=false;
  BD5.Enabled:=false;
...
procedure TDelOther_INK.FormDestroy(Sender: TObject);
begin
  DelOther_INK:=nil;
end;

procedure TDelOther_INK.DBGrid3GetCellParams(Sender: TObject;
...
procedure TDelOther_INK.DBGrid4GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
...
procedure TDelOther_INK.BBTT2Click(Sender: TObject);
begin
  if messagedlg('Select material from order?',mtinformation,[mbYes,mbNo],0)=mrYes then
  begin
    DelOther_INK_Mat:=TDelOther_INK_Mat.create(self);
    DelOther_INK_Mat.show;
  end
  else
    begin
      DelOther_INK_CL:=TDelOther_INK_CL.create(self);
      DelOther_INK_CL.show;
    end;
end;
