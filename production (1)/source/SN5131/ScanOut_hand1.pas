...
procedure TScanOut_hand.FormDestroy(Sender: TObject);
begin
ScanOut_hand:=nil;
end;

procedure TScanOut_hand.FormClose(Sender: TObject;
...
procedure TScanOut_hand.Button1Click(Sender: TObject);
begin
...
procedure TScanOut_hand.DBGridEh1DblClick(Sender: TObject);
var s:string;
begin
...
procedure TScanOut_hand.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TScanOut_hand.DBGridEh2KeyPress(Sender: TObject; var Key: Char);
begin 
if key=#13 then
  DBGrideh2dblclick(nil);
end;

procedure TScanOut_hand.DBGridEh2DblClick(Sender: TObject);
var s:string;
begin
if YWCP.recordcount=0 then
  begin
...
procedure TScanOut_hand.FormShow(Sender: TObject);
begin
