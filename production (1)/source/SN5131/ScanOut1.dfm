object ScanOut: TScanOut
  ...
  object Panel3: TPanel
    ...
    object CheckBox3: TRadioButton
      ...
      Width = 265
      Height = 17
      Caption = 'KH tai che '#23458#20154#32763#31665
      TabOrder = 10
    end
    object CheckBox4: TRadioButton
      Left = 1025
      Top = 41
      Width = 224
      Height = 21
      Caption = 'Don Hang Huy '#21462#28040#35330#21934' '
      TabOrder = 11
    end
  end
  ...
  object YWCP: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select CARTONBAR,XH,Qty,LPNBarCode'
      'from YWCP'
