...
begin
  ...
  UserIDList:='15474,08688,36994,16255,01775,001178,001396,001015';
  if FileExists(AppDir+'\ComName.ini')=true then
  begin
    try
      MyIni := Tinifile.Create(AppDir+'\ComName.ini');
      UserIDList:=MyIni.ReadString('UserID','Production_N321_DelOther','15474,08688,36994,16255,01775,001178,001396,001015');
    finally
      MyIni.Free;
    end;
  end;
