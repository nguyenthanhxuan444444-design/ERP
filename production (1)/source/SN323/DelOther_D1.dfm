object DelOther_D: TDelOther_D
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
        ...
        '       ,CLZL.YWPM,CLZL.DWBH,SCBLYY.YWSM,SCBLYY.ZWSM,CLZL.ZWPM,KC' +
        'LLS.LLMemo'
  ...
  object UPDet: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into KCLLS'
        ...
        'CostID, '
      '   USERDATE, USERID, YN, CLSL, YYBH, VNACC, MEMO, LLMemo)'
      'values'
  ...
  object DelMas: TQuery
    ...
    object DelMasMEMO: TStringField
      FieldName = 'MEMO'
      Origin = 'DB.KCLL.MEMO'
      OnSetText = DelMasMEMOSetText
      FixedChar = True
      Size = 10
    end
    object DelMasBP: TBooleanField
      FieldName = 'BP'
    end
  end
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into KCLL'
        ...
        'ID, YN, SEASON, PURPOSE, DEVTYPE ,MEMO,BP)'
      'values'
      
        '  (:LLNO, :GSBH, :CKBH, :SCBH, :DepID, :USERDATE, :USERID, :CFMD' +
        'ate,:CFMID,:YN, :SEASON, :PURPOSE, :DEVTYPE ,:MEMO, :BP)')
    DeleteSQL.Strings = (
      'delete from KCLL'
      'where'
      '  LLNO = :OLD_LLNO')
