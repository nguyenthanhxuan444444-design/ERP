...
with query1 do
  begin
    ...
    sql.add('left join KCZLS on KCZLS.CLBH=CLZL.CLDh and KCZLS.CKBH='+''''+DelChemical.DelMas.fieldbyname('CKBH').value+'''');
...
procedure TDelChemical_Mat.DBGrid1DblClick(Sender: TObject);
begin
...
procedure TDelChemical_Mat.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
