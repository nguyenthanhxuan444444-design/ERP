...
procedure TDelMaterial_Dep.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TDelMaterial_Dep.DBGridEh1KeyPress(Sender: TObject;
  var Key: Char);
begin
   if key=#13 then
...
procedure TDelMaterial_Dep.FormShow(Sender: TObject);
begin
